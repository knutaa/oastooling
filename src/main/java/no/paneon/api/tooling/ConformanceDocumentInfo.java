...
public class ConformanceDocumentInfo {
	...
	public String getDocID() {
		...
		return docId + Config.getString("conformance.docId.postfix");
	...
	public String getTitle() {
		...
		String res = optDocTitle.isPresent() ? optDocTitle.get() : 
					 optDocTitleAPI.isPresent() ? optDocTitleAPI.get() : 
					 "TBD";
		
		res = res + " Conformance Profile";
